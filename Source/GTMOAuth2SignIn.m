    ...
    if (error) {
        ...
        if (data) {
            ...
            if (profileDict) {
                ...
                if ([[profileDict objectForKey:@"verified_email"] isKindOfClass:[NSString class]]) {
                    NSString *verified = [profileDict objectForKey:@"verified_email"];
                    [auth setUserEmailIsVerified:verified];
                }else if ([[profileDict objectForKey:@"verified_email"] isKindOfClass:[NSNumber class]]) {
